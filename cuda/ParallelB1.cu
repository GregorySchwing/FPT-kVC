#include "ParallelB1.cuh"
#include <math.h>       /* pow */
// Sum of i = 0 to n/2
// 3^i
__host__ __device__ int ParallelB1::CalculateWorstCaseSpaceComplexity(int vertexCount){
    int summand= 0;
...
__host__ __device__ long long ParallelB1::CalculateSpaceForDesiredNumberOfLevels(int NumberOfLevels){
    long long summand= 0;
    // ceiling(vertexCount/2) loops
